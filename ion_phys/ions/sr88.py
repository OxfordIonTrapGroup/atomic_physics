    ...
    def __init__(self, *, B=None, level_filter=None):
        ...
        transitions = {
            "422": Transition(
                ...
                upper=P12,
                A=127.9e6,  # [1]
                freq=2 * np.pi * 711162972859365.  # [1]
            ),
            "408": Transition(
                lower=S12,
                upper=P32,
                A=141e6,  # [1]
                freq=2 * np.pi * 735197363032326.  # [1]
            ),
            "1092": Transition(
                lower=D32,
                upper=P12,
                A=7.46e6,  # [1]
                freq=2 * np.pi * 274664149123480.  # [1]
            ),
            "1004": Transition(
                lower=D32,
                upper=P32,
                A=1.0e6,  # [1]
                freq=2 * np.pi * 298697611773804.  # [1]
            ),
            "1033": Transition(
                lower=D52,
                upper=P32,
                A=8.7e6,  # [1]
                freq=2 * np.pi * 290290973185754.  # [1]
            ),
            "674": Transition(
                lower=S12,
                upper=D52,
            ...
            "687": Transition(
                ...
                upper=D32,
                A=2.299,  # [1]
                freq=2 * np.pi * 436495331872197.  # [1]
            ),
        }
